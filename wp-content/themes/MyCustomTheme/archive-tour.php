...
<?php $homeurl = get_home_url(); ?>
		...
		<section id="slider" class="slider-parallax" style="background-color: #222;">
			...
			<div id="oc-slider" class="owl-carousel carousel-widget" data-margin="0" data-items="1" data-pagi="false" data-loop="true" data-animate-in="rollIn" data-speed="450" data-animate-out="rollOut" data-autoplay="5000">
				...
				<a href="#"><img src="<?php echo get_template_directory_uri() ?>/images/slider/full/1.jpg" alt="Slider"><div class="overlay" style="top: 50%;"><h2 style="text-align:center; direction:rtl;">تورها</h2></div></a>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					<ul class=" clearfix center"  style="margin-bottom:20px;list-style:none">
							...
							<li id="list-filter" style="display:inline;margin: 0 0 0 25px;"><a href="<?php echo $homeurl ?>/category/one-day/" class="button button-circle" style="font-family:BYekan;background-color:transparent;;color:black">تورهای یک روزه</a></li>
							<li id="list-filter" style="display:inline;margin: 0 0 0 25px;"><a href="<?php echo $homeurl ?>/category/multiple-days/"  class="button button-circle" style="font-family:BYekan;background-color:transparent;;color:black">تورهای چند روزه</a>
							<li id="list-filter" class="active" style="display:inline;margin: 0 0 0 25px;"><a class="button button-circle" href="#"  style="font-family:BYekan;background-color:transparent;color:black">همه تورها</a></li></li>
					</ul>
					<!-- Shop
					============================================= -->
					...
					$args = array('post_type' => 'tour', 'posts_per_page' => '12','paged' => $paged);
